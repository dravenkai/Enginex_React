...
import { LayoutDashboard, Users, FolderKanban, User, LogOut } from "lucide-react";
import { logout } from "@/lib/auth/api";
import { useAuthStore } from "@/lib/auth/store";

const navItems = [
  { name: "Team Overview", icon: LayoutDashboard, href: "/team/dashboard" },
  { name: "Team Members", icon: Users, href: "/team/members" },
  { name: "Project", icon: FolderKanban, href: "/team/project" },
  { name: "Team Profile", icon: User, href: "/team/profile" },
];
          ...
          return (
            <Link
              ...
              className={`flex items-center gap-3 p-3 font-semibold transition-all ${
                isActive
                  ? "bg-[#86efac] border-2 border-black shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]"
