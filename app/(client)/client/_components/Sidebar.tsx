    ...
    <div className="w-64 h-screen bg-white border-r-4 border-black flex flex-col">
      <div className="p-6 border-b-4 border-black flex items-center gap-2">
        <div className="w-10 h-10 bg-white border-2 border-black flex items-center justify-center">
          <img src="/next.svg" alt="Logo" className="w-6 h-6" />
        </div>
      ...
      <div className="p-4 border-t-4 border-black bg-[#fef08a]">
        <button className="w-full flex items-center justify-center gap-2 p-3 font-bold border-2 border-black bg-transparent hover:bg-black hover:text-[#fef08a] transition-all active:translate-x-1 active:translate-y-1 active:shadow-none shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] uppercase tracking-wider">
