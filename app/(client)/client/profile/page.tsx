    ...
    <div className="p-8 space-y-8 max-w-[1400px] mx-auto">
      {error && (
        <div className="bg-red-50 border-2 border-red-400 text-red-700 p-4 text-sm font-medium flex items-center justify-between gap-4">
          <span>Couldn&apos;t load your profile from the server: {error}</span>
          <button
            type="button"
            onClick={reload}
        ...
        <div className="lg:col-span-2 bg-white border-4 border-black p-8 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] flex flex-col sm:flex-row gap-6">
          <div className="relative w-28 h-28 shrink-0">
            ...
            <button
              ...
              className="absolute -bottom-2 -right-2 shadow-[3px_3px_0px_0px_rgba(0,0,0,1)] w-8 h-8 grid place-items-center bg-[#93c5fd] border-2 border-black"
            >
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-start justify-between gap-4">
              <h2 className="text-2xl font-black">
                {loading ? "Loading…" : (user?.name ?? "Your Name").toUpperCase()}
              </h2>
              <Link
