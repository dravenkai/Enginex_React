    ...
    <main className={styles.page}>
      ...
      <aside className={styles.artPanel} aria-hidden="true">
        <div className={styles.notice}>
          <span className={styles.iconTile}><Mail size={24} /></span>
          <span><p className={styles.artTitle}>Email Sent</p><p className={styles.artText}>Delivery confirmed</p></span>
        </div>
        <div className={styles.lock}><LockKeyhole size={31} /></div>
        <div className={styles.keyCard}>
          <span className={styles.iconTile}><KeyRound size={24} /></span>
          <span><p className={styles.artTitle}>Reset Key</p><p className={styles.artText}>Valid for 24h</p></span>
        </div>
        <span className={`${styles.plane} ${styles.planeOne}`}>⌁</span>
        <span className={`${styles.plane} ${styles.planeTwo}`}>⌁</span>
        <span className={`${styles.plane} ${styles.planeThree}`}>⌁</span>
