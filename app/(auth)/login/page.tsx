...
function Icon({ type }: { type: "mail" | "lock" | "eye" | "arrow" | "bolt" | "shield" | "users" }) {
  const shapes = {
...
function Logo() {
  return (
    <svg className={styles.logo} viewBox="0 0 100 90" aria-label="Enginex logo">
      ...
      <rect x="51" y="28" width="5" height="5" fill="#fff"/><rect x="61" y="22" width="5" height="5" fill="#fff"/><rect x="61" y="32" width="5" height="5" fill="#fff"/>
      <circle cx="66" cy="62" r="5" fill="#2b9ed0"/><path d="M59 75c0-6 3-10 7-10s7 4 7 10" fill="#2b9ed0"/>
    </svg>
  );
}
